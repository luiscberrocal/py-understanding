...
results1 = timeit.timeit(stmt="regular_read_csv(csv)", setup=setup_code, number=10)
print(f"regular_read_csv: {results1:.2f} seconds")

results2 = timeit.timeit(stmt="py_arrow_read_csv(csv)", setup=setup_code, number=10)
