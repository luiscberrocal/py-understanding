...
if __name__ == "__main__":
    ...
    origin_branches = [
        ...
        "origin/develop",
        "origin/feature/1093_cluster_upgrade",
        "origin/feature/OP-176_Upgrade_SSL_libs",
        "origin/feature/WWW-10_eliminating_landing_pages",
        "origin/feature/WWW-3_Update_django_and_pillow",
        "origin/feature/add_endpoint_to_resend_transactions ",
        "  origin/feature/get_deployment_working",
        "origin/feature/s55_fix_wu_integration_k8s_deployment",
        "origin/master",
    ]
