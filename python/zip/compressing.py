...
def unzip_file(zip_file: Path, target_folder: Path, password: str) -> List[Path]:
    ...
    with zipfile.ZipFile(zip_file, 'r') as zf:
        ...
        for file in files:
            ...
            unzipped_files.append(target_folder / file)
...
if __name__ == '__main__':
    ...
    unzip_files = unzip_file(zip_file=z_file, target_folder=output_folder, password=pwd)
