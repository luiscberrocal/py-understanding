...
def unzip_file_independent(zip_file: Path, target_folder: Path, password: str):
    with zipfile.ZipFile(zip_file, 'r') as zip:
        files = zip.namelist()
        for file in files:
...
if __name__ == '__main__':
    ...
    unzipped_files = unzip_file_independent(zip_file=z_file, target_folder=output_folder, password=pwd)
